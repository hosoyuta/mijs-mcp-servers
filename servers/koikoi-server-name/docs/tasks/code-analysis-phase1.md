...
##### - [ ] TASK-0120: ProgramManager基本実装 (TDD Red→Green)
- **タスクタイプ**: TDD
- **推定工数**: 5時間
- **要件名**: code-analysis
- **依存タスク**: TASK-0118
...
##### - [ ] TASK-0121: ProgramManager Refactor + mtime対応
- **タスクタイプ**: TDD
- **推定工数**: 3時間
- **要件名**: code-analysis
- **依存タスク**: TASK-0120
...
##### - [ ] TASK-0122: SourceFileCache実装 (TDD Red→Green)
- **タスクタイプ**: TDD
- **推定工数**: 5時間
- **要件名**: code-analysis
- **依存タスク**: TASK-0121
...
##### - [ ] TASK-0123: Day 8振り返りとパフォーマンステスト
- **タスクタイプ**: DIRECT
- **推定工数**: 3時間
- **要件名**: code-analysis
- **依存タスク**: TASK-0122
...
**完了条件**:
- [ ] 統合テスト全通過
- [ ] CompilerHost + ProgramManager + SourceFileCache統合確認
...
##### - [ ] TASK-0126: Week 2総合テストとリファクタリング
- **タスクタイプ**: DIRECT
- **推定工数**: 6時間
- **要件名**: code-analysis
- **依存タスク**: TASK-0125
